<?php
/**
 * Inserir Usuários de Teste - LOCAL - Iguincho
 * Script para criar usuários mocados para teste no banco local
 */
...
try {
    echo "<h2>👥 Criação de Usuários de Teste LOCAL - Iguincho</h2>\n";
    echo "<pre>\n";
    
    echo "🔧 Iniciando criação de usuários de teste no banco LOCAL...\n\n";
    
    // Dados do cliente de teste
    $clientData = [
        'full_name' => 'João Silva Santos (Local)',
    ...
    $driverUserData = [
        'full_name' => 'Carlos Eduardo Moreira (Local)',
        'cpf' => '222.555.888-46',
    ...
    // Conectar ao banco (detectará automaticamente se é local ou produção)
    $database = new Database();
    $conn = $database->getConnection();
    
    // Verificar qual ambiente estamos usando
    $testResult = $database->testConnection();
    echo "🌐 Ambiente: " . $testResult['environment'] . "\n";
    echo "🗄️  Banco: " . $testResult['host'] . " -> " . $testResult['database'] . "\n\n";
    ...
    try {
        ...
        echo "📋 Detalhes do erro: " . $e->getFile() . " (linha " . $e->getLine() . ")\n\n";
    }
    ...
    echo "\n🔧 Verifique:\n";
    echo "  • Banco local foi criado com setup_local.php\n";
    echo "  • XAMPP MySQL está rodando\n";
    echo "  • Classes User e Driver estão funcionando\n";
    echo "</pre>\n";
}
?>
...
<html>
<head>
    <title>Usuários de Teste LOCAL - Iguincho</title>
    <style>
...
<body>
    <p><a href="../test/api-test.php">🧪 Testar API</a> | <a href="setup_local.php">🔧 Setup DB Local</a> | <a href="../../index.html">🏠 Login</a></p>
</body>
</html>